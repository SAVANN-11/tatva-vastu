...
function SocialBar() {
  const socials = [
   ...
   // { name: "YouTube", icon: SocialIcons.youtube, url: "https://www.youtube.com/@tatvaVastu", color: "#FF0000" },
    { name: "WhatsApp", icon: SocialIcons.whatsapp, url: "https://wa.me/+91 9662013329", color: "#25D366" },
  ];
  return (
      ...
      <section style={{ padding: "4rem 5%", textAlign: "center", background: "rgba(91,45,142,0.1)", borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <Reveal>
          ...
          <p style={{ fontFamily: FONTS.sans, color: COLORS.textMuted, fontSize: "0.9rem", marginBottom: "2rem" }}>
            Call us: <a href="tel:+91 9662013329" style={{ color: COLORS.gold, fontWeight: 700, textDecoration: "none" }}>+91 9662013329</a>
          </p>
            ...
            <Reveal>
              <div style={{ background: "rgba(91,45,142,0.12)", border: "1px solid rgba(201,168,76,0.2)", padding: "2.5rem", borderRadius: "8px" }}>
                ...
                <p style={{ fontFamily: FONTS.sans, fontSize: "0.72rem", color: COLORS.textMuted, textAlign: "center", marginTop: "1rem" }}>
                  Or call directly: <a href="tel:+91 9662013329" style={{ color: COLORS.gold, textDecoration: "none", fontWeight: 700 }}>+91 9662013329</a>
                </p>
              </div>
            </Reveal>
          )}
    ...
    <div style={{ paddingTop: "80px" }}>
      ...
      <section style={{ padding: "1rem 5% 5rem" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.8fr", gap: "2.5rem", alignItems: "start" }} className="booking-layout">
          <Reveal>
            <div>
              <a href="tel:+91 9662013329" style={{ textDecoration: "none" }}>
                <div style={{ background: `linear-gradient(135deg, ${COLORS.purple}, ${COLORS.purpleDark})`, border: `2px solid ${COLORS.gold}`, borderRadius: "8px", padding: "1.8rem", textAlign: "center", marginBottom: "1.2rem", cursor: "pointer" }}>
                  ...
                  <div style={{ fontFamily: FONTS.sans, fontSize: "1.2rem", color: COLORS.white, fontWeight: 700, letterSpacing: "0.05em" }}>+91 9662013329</div>
                  <div style={{ fontFamily: FONTS.sans, fontSize: "0.72rem", color: COLORS.cream2, marginTop: "0.5rem" }}>Tap to call directly</div>
                </div>
              </a>
              <a href="https://wa.me/+91 9662013329?text=Hello%2C%20I%20want%20to%20book%20a%20Vastu%20consultation." target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
...
function ContactPage() {
  const socials = [
    ...
    { name: "WhatsApp", icon: SocialIcons.whatsapp, url: "https://wa.me/+91 9662013329", color: "#25D366", handle: "+91 9662013329" },
  ];
  return (
    <div style={{ paddingTop: "80px" }}>
      <section style={{ padding: "5rem 5% 3rem", textAlign: "center" }}>
      ...
      <section style={{ padding: "1rem 5% 5rem", maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.2rem", marginBottom: "3rem" }}>
          {[
            { icon: "📞", label: "Phone / WhatsApp", val: "+91 9662013329", link: "tel:+91 9662013329" },
        ...
        <Reveal>
          <div style={{ textAlign: "center", background: "rgba(91,45,142,0.12)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "8px", padding: "2.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              <a href="tel:+91 9662013329" style={{ background: COLORS.gold, color: COLORS.purpleDeep, fontFamily: FONTS.sans, fontSize: "0.78rem", letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 700, padding: "0.9rem 1.8rem", borderRadius: "2px", textDecoration: "none" }}>📞 Call Now</a>
              <a href="https://wa.me/+91 9662013329" target="_blank" rel="noopener noreferrer" style={{ background: "#25D366", color: "#fff", fontFamily: FONTS.sans, fontSize: "0.78rem", letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 700, padding: "0.9rem 1.8rem", borderRadius: "2px", textDecoration: "none" }}>WhatsApp</a>
            </div>
          </div>
        </Reveal>
      </section>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "2.5rem", maxWidth: 1100, margin: "0 auto 2.5rem" }} className="footer-grid">
        <div>
          ...
          <div style={{ fontFamily: FONTS.sans, fontSize: "0.82rem", color: COLORS.cream, marginBottom: "0.4rem" }}>
            <a href="tel:+91 9662013329" style={{ color: COLORS.gold, textDecoration: "none", fontWeight: 700 }}>📞 +91 9662013329</a>
          </div>
